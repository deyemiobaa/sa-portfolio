  ...
  return (
    <div className="mx-auto mb-10 home">
      ...
      <section id="intro" aria-label="intro">
        ...
        <Link href="/contact">
          <button type="button" className="border px-8 mt-6 py-1 border-teal-300 bg-transparent hover:bg-teal-300 hover:border ease-in-out duration-700 transition-colors text-teal-300 hover:text-black font-bold w-max sticky z-[11]">Get in touch</button>
        </Link>
      </section>
