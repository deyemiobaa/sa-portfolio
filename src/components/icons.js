  ...
  return (
    <>
      ...
      <a
        ...
        rel="noopener noreferrer"
      >
        <FiGithub className="text-teal-500 text-lg" />
      </a>
      <a
        ...
        rel="noopener noreferrer"
      >
        <FiLinkedin className="text-teal-500 text-lg" />
      </a>
      <a
        ...
        rel="noopener noreferrer"
      >
        <FiTwitter className="text-teal-500 text-lg" />
      </a>
      <a
        ...
        rel="noopener noreferrer"
      >
        <SiLichess className="text-teal-500 text-lg" />
      </a>
    </>
  )
}