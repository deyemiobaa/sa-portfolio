...
export default function Project({ title, description, image, technologies, link }) {
  return (
    <a href={link} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center rounded-lg bg-black/[0.55] shadow-lg hover:scale-[1.01] hover:transition-transform hover:ease-in-out hover:duration-[300ms] static z-10">
