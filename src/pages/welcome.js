    ...
    <div className="px-6 leading-7 lg:leading-10 tracking-wide  font-light">
      <div className="w-4/4 md:w-3/4 mx-auto mb-10 static z-10">
        <div className="h-screen flex flex-col justify-center relative">
          ...
          <div className="text-big absolute z-1 left-0 bottom-32 opacity-[0.02] font-black font-elsie hidden lg:block">
            Hello
          </div>
        </div>
        <div>
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-x-4 md:w-3/5 text-[15px] list-[square] ml-4 my-8">
