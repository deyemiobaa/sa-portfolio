...
export default function Contact() {
  return (
    <main className="relative flex flex-col items-center px-6 mb-20 leading-7 tracking-wide lg:leading-10 mt-28 md:mt-36">
      <div className="static z-10 mx-auto w-4/4 md:w-3/4">
        ...
        <figure className="opacity-[.9] text-base text-white">
          <blockquote cite="https://deyemiobaa.vercel.app">
            <p className="pl-6 mb-4 border-l-4 border-neutral-700">There are no strangers here; Only friends you haven’t yet met.</p>
          </blockquote>
        ...
        <p>You can reach out to me via my social links, or send me a message using the form below. I'd love to hear from you.</p>
        <Form />
      </div>
    </main>
  );
