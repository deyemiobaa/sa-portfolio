...
export default function Projects() {
  ...
  return (
    <div className="px-6 leading-7 tracking-wide lg:leading-10 mt-28 md:mt-36">
      <div className="static z-10 mx-auto mb-10 w-4/4 md:w-3/4">
        ...
        <div id="projects-section" className="grid w-full grid-cols-1 gap-8 mb-20 text-center text-white md:grid-cols-2 lg:mb-0">
